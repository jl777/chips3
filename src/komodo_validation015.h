...
static const char *notaries_elected[NUM_KMD_SEASONS][NUM_KMD_NOTARIES][2] =
{
    ...
    {
        // New pubkeys from @kolo will go here, CHIPS should use KMD ->BTC keys as we control the repo of chips. 
        {"webworker01_NA", "03bb7d005e052779b1586f071834c5facbb83470094cff5112f0072b64989f97d7" }
    }
};
...
int32_t komodo_notaries(uint8_t pubkeys[64][33],int32_t height,uint32_t timestamp)
{
    ...
    {
        // If usaing height activation, use this path. 
        kmd_season = getkmdseason(height);
    }
    else 
    {
        // if using timestamp activation use this path, its the default, only for ease, I strongly suggest using a height activation!
