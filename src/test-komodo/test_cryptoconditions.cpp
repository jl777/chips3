...
public:
    void CCSign(CMutableTransaction &tx, CC *cond) {
        ...
        uint256 sighash = SignatureHash(CCPubKey(cond), tx, 0, SIGHASH_ALL, 0, SigVersion::BASE, &txdata);

        cc_signTreeSecp256k1Msg32(cond, notaryKey.begin(), sighash.begin());
